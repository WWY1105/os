    ...
    return {
        ...
        link: function (b, c, d, e) {
            ...
            e._refreshView = function () {
                ...
                for (var n = 0; 7 > n; n++)
                { b.labels[n] = {
                    abbr:weekcn[l[n].date.getDay()],
                    full:"星期"+weekcn[l[n].date.getDay()]
                };
            }
    ...
    return {
        ...
        link: function (a, b, c, d) {
            ...
            d.step = {
                ...
                for (var b = new Array(f), c = 0, g = e(d.activeDate.getFullYear()); f > c; c++) b[c] = angular.extend(d.createDateObject(new Date(g + c, 0, 1), "yyyy"), {
                    uid: a.uniqueId + "-" + c
                });
